  ...
  return (
    ...
    >
      ...
      >
              ...
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <textarea
                    ...
                    onBlur={(event) =>
                      updateSection(index, { items: lines(event.target.value) })
                    }
            ...
            {(reference.items || []).map((item, index) => (
              ...
              >
                <input
                  ...
                  onChange={(event) =>
                    save({
                      items: (reference.items || []).map((entry, itemIndex) =>
                        itemIndex === index
                ...
                <input
                  ...
                  onBlur={(event) =>
                    save({
                      items: (reference.items || []).map((entry, itemIndex) =>
                        itemIndex === index
                          ? { ...entry, description: event.target.value.trim() }
                          : entry,
                      ),
                    })
                  }
          ...
          <div className="grid grid-cols-[1fr_42px_1fr] items-stretch gap-3">
            <label className="rounded-xl border bg-blue-50/40 p-3">
              ...
              <textarea
                ...
                onBlur={(event) => save({ current: lines(event.target.value) })}
        ...
        {node.type === "terminal" ? (
          <div className="absolute inset-x-3 bottom-6 top-3 flex min-h-0 flex-col items-center justify-center rounded-xl bg-emerald-50/70 px-6 text-center dark:bg-emerald-950/30">
            <ComponentNoteButton
              nodeId={node.id}
              noteKey="completion"
