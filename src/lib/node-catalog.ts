...
export const NODE_CATALOG: NodeDefinition[] = [
  ...
  { type: "opportunityValidation", label: "Opportunity Node", description: "Objective evidence intake, Class D reality check, and bounded routing", icon: Target, color: "#1f5fa7", category: "Flow", defaultSize: { width: 480, height: 460 } },
