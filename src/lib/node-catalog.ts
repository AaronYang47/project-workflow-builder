...
import { Activity, AlertTriangle, BookOpenCheck, Bot, Boxes, BriefcaseBusiness, CircleDot, CircleStop, ClipboardCheck, FileStack, FileText, FolderKanban, Handshake, Landmark, Layers3, ListChecks, MessageSquareText, Network, Repeat2, ShieldCheck, Table2, Tags, Trophy, UsersRound } from "lucide-react";
...
export const NODE_CATALOG: NodeDefinition[] = [
  ...
  { type: "approvalMatrix", label: "Approval Matrix — Forms & Actions", description: "Forms and actions by approval role", icon: Table2, color: "#334e73", category: "Governance", defaultSize: { width: 360, height: 190 } },
  ...
  { type: "responsibilityLane", label: "RM — Responsibility Matrix", description: "Scope and ownership by delivery area", icon: UsersRound, color: "#476b8d", category: "Governance", defaultSize: { width: 360, height: 190 } },
