...
export const NODE_CATALOG: NodeDefinition[] = [
  ...
  { type: "opportunityValidation", label: "Opportunity Validation", description: "Validate client, decision makers, scale, budget, fit, and engagement path", icon: Compass, color: "#1f5fa7", category: "Flow", defaultSize: { width: 840, height: 760 } },
